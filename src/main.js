...
;(function(window) {
	 ...
	 * Init/Bind events.
	 */
	TiltFx.prototype.initEvents = function() {
		var self = this;
		...
		this.mousemoveFn = function(ev) {
			requestAnimationFrame(function() { self.layout(ev); });
		};
	...
	TiltFx.prototype.layout = function(ev) {
...
document.querySelectorAll('a.tilter').forEach(function(el) { 
    new TiltFx(el);
});